<template>
  <div class="mine">
    <div class="banner">
      <img src="../../../static/imgs/mine1.png" alt />
    </div>
    ...
    <div class="interior">
      ...
      <div class="interior-right">
        <img src="../../../static/imgs/mine2.png" alt />
      </div>
    </div>
    ...
    <div class="external">
      <div class="external-left">
        ...
        <p class="external-left-p">Inside the mine</p>
      </div>
      <div class="external-right">
        <img src="../../../static/imgs/mine3.png" alt />
        <img class="img3" width="368" height="260" src="../../../static/imgs/mine3.png" alt />
        <span class="external-span">The mine equipmen</span>
      </div>
    </div>

    <div class="hydropower">
      <img style="margin-right: 25px;" src="../../../static/imgs/mine5.png" alt="">
      <img style="margin-right: 48px;" src="../../../static/imgs/mine6.png" alt="">
      <div class="interior-left">
        <div class="describe">
          <h3 class="h3">水电站</h3>
